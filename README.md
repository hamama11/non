...
# 🎓 Non술 지원 시간표 설계기 v2 (SM Smart Match)
...
3. **"이렇게 써볼까? 저렇게 써볼까?" (새 시간표 탭 & 인쇄)**
   ...
   - 맘에 쏙 드는 시간표가 완성됐다면 `🖨️ 인쇄` 버튼을 눌러 책상 앞에 붙여두세요!
...
- 하단의 **[📊 모의 지원 대학 요약]**에서 내가 최종 픽(Pick)한 6개 대학을 한눈에 확인할 수 있습니다.
...
지속적으로 진화해 온 논술 시간표 설계기의 디자인 히스토리입니다.

| 버전 1 (v1) | 버전 2 (v2) | 버전 3 (v3 - 최신) |
| :---: | :---: | :---: |
| <img src="v1캡처.png" width="230" alt="v1" /> | <img src="v2캡처.png" width="230" alt="v2" /> | <img src="v3캡처.png" width="230" alt="v3" /> |
